 ...
 * "Authentication Server API functionality tests" section. Kept verbatim - including a
 * couple of apparent inconsistencies in that document, noted below - for direct
...
public final class ScenarioIdentifiers {
    ...
    // sic: the test plan numbers both mobile nr scenarios "NEG-05"
    public static final String NEG_START_AUTH_05_MOBILE_NR_TOO_SHORT = "POST_START_AUTH-NEG-05-MOBILE_NR_TOO_SHORT";
    public static final String NEG_START_AUTH_05_MOBILE_NR_TOO_LONG = "POST_START_AUTH-NEG-05-MOBILE_NR_TOO_LONG";
    ...
    // sic: the test plan prefixes these ids "POST_", even though "/auth/status" is a GET
    // endpoint (compare with the "GET_AUTH_STATUS-POS-*" ids above)
    public static final String NEG_AUTH_STATUS_01 = "POST_AUTH_STATUS-NEG-01-UUID_TOO_SHORT";
    public static final String NEG_AUTH_STATUS_02 = "POST_AUTH_STATUS-NEG-02-UUID_TOO_LONG";
    public static final String NEG_AUTH_STATUS_03 = "POST_AUTH_STATUS-NEG-03-UUID_MALFORMED";
    public static final String NEG_AUTH_STATUS_04 = "POST_AUTH_STATUS-NEG-04-AUTH_PROCESS_NOT_FOUND";
